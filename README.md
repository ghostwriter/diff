...
[![Automation](https://github.com/ghostwriter/diff/actions/workflows/automation.yml/badge.svg)](https://github.com/ghostwriter/diff/actions/workflows/automation.yml)
[![PHP Version](https://badgen.net/packagist/php/ghostwriter/diff?color=777BB4)](https://www.php.net/supported-versions)
[![Packagist Downloads](https://badgen.net/packagist/dt/ghostwriter/diff?color=F28D1A)](https://packagist.org/packages/ghostwriter/diff)
...
[![Sponsors via GitHub](https://img.shields.io/github/sponsors/ghostwriter?label=Sponsor+@ghostwriter/diff&logo=GitHub+Sponsors)](https://github.com/sponsors/ghostwriter)

Myers Algorithm - Diff implementation for PHP
...
``` bash
composer require ghostwriter/diff
```
...
- [All Contributors](https://github.com/ghostwriter/diff/contributors)
